  ...
  const handleWalletPayment = async () => {
    ...
    try {
      const mappedOrderData = {
        ...
        description: orderData.description || orderData.furnitureDescription,
      ...
      const errorMessage = error.response?.data?.error || 'Wallet payment failed. Please try again or use Paystack.';
