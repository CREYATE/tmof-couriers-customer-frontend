  ...
  return (
    <Card className="max-w-md mx-auto mt-8 p-6">
      ...
      <div className="flex flex-col gap-4">
        <Button onClick={onNext} className="bg-[#ffd215] hover:bg-[#e5bd13] text-black">Stand Delivery</Button>
        <Button onClick={onNext} className="bg-[#ffd215] hover:bg-[#e5bd13] text-black">Parcel Delivery</Button>
        <Button onClick={onNext} className="bg-[#ffd215] hover:bg-[#e5bd13] text-black">Electronics Delivery</Button>
        <Button onClick={onNext} className="bg-[#ffd215] hover:bg-[#e5bd13] text-black">Furniture Moving</Button>
        <Button onClick={onNext} className="bg-[#ffd215] hover:bg-[#e5bd13] text-black">Swift Errand</Button>
      </div>
    </Card>
  );
}
